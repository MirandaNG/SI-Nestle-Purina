            ...
            <tbody>
                <?php while ($empleado = $empleados->fetch_assoc()) : ?>
                    <tr>
                        ...
                        <td>
                            <?php
                            // Mostrar el nombre del departamento (suponiendo que tienes una tabla departamentos)
                        ...
                        <td>
                            <a href="editar_empleado.php?id=<?php echo $empleado['empl_id']; ?>" class="btn btn-warning btn-sm">Editar</a>
                            <a href="eliminar_empleado.php?id=<?php echo $empleado['empl_id']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('¿Estás seguro de eliminar este empleado?');">Eliminar</a>
                        </td>
                    </tr>
                <?php endwhile; ?>
            </tbody>
